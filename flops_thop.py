...
from models.mobilefacenet_add import MobileFaceNet_y2_se, MobileFaceNet_y2_2, MobileFaceNet_sor, MobileFaceNet_y2_3,\
    MobileFaceNet_y2_se_all, MobileFaceNet_y2_se_all2
from models.mobilefacenet_add import MobileFaceNet_y2_4, MobileFaceNet_y2_5, MobileFaceNet_y2_6, mf_y2_mbv2_t6
from models.mobilenetv3 import MobileNetV3_Small, MobileNetV3_Large, MobileNetV3_Large_ex2, MobileNetV3_Large_epx2, MobileNetV3_Large_3

from models.sknet import SKNet
from models.mf_y2_sknet import mf_y2_sknet, mf_y2_sknet_res,  mf_y2_sknet_res_se8, mf_y2_sknet_M3_R16_res_SE8
from models.mf_y2_sknet import mf_y2_res_sknet_M3, mf_y2_SE8_res_sknet_M3_R16, mf_y2_SEall_res_sknet_M3_R16

from models.efficientnet_pytorch.efficientnet import EfficientNet
...
# model = MobileNetV3_Large_3(512)
#
# model = SKNet(512)

# model = mf_y2_sknet(512)
# model = mf_y2_sknet_res(512)
# model = mf_y2_res_sknet_M3(512)
# model = mf_y2_SE8_res_sknet_M3_R16(512)
# model = mf_y2_SEall_res_sknet_M3_R16(512)
...
model = MobileFaceNet_y2_se_all2(512)
